    ...
    [33], {
        1195: (e, t, s) => {
            ...
            class NestedCarousel extends elementorModules.frontend.handlers.CarouselBase {
                ...
                async onInit() {
                    this.wrapSlideContent(), super.onInit(...arguments), this.isSwiperUpgradeExperimentStateInactive() && this.reInitBackgroundSlideshow(), this.ranElementHandlers = !1
                }
                isSwiperUpgradeExperimentStateInactive() {
                    return !!elementorFrontend.config.experimentalFeatures.hasOwnProperty("e_swiper_latest") && !elementorFrontend.config.experimentalFeatures.e_swiper_latest
                }
                async initSwiper() {
