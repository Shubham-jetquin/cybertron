...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head>
        <link rel="icon" href="https://cybertron-tech.com/wp-content/uploads/2025/02/logo-removebg-preview-75x75.png" sizes="32x32" />
        <link rel="icon" href="https://cybertron-tech.com/wp-content/uploads/2025/02/logo-removebg-preview.png" sizes="192x192" />
        <link rel="apple-touch-icon" href="https://cybertron-tech.com/wp-content/uploads/2025/02/logo-removebg-preview.png" />
        ...
        {/* Script */}
        <script src="https://cybertron-tech.com/wp-content/plugins/elementor/assets/lib/font-awesome/js/v4-shims.min.js?ver=3.27.6" id="font-awesome-4-shim-js"></script>
        <script src="https://cybertron-tech.com/wp-includes/js/jquery/jquery.min.js?ver=3.7.1" id="jquery-core-js"></script>
        <script src="https://cybertron-tech.com/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.4.1" id="jquery-migrate-js"></script>
      </head>
      <body
